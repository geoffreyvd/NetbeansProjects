...
public class Sorter {
    ...
    public static void bucketSort(ArrayList<Student> studenten, Comparator c) {
        ArrayList<KlasBucket> klassenBuckets = new ArrayList<>();
        for (Student student : studenten) {
            for (KlasBucket klassenBucket : klassenBuckets) {
                if (student.getKlas().toString() != klassenBucket.toString()) {
                    klassenBuckets.add(new KlasBucket(student.getKlas().getLeerroute(), student.getKlas().getKlasNummer()));
                }else{
